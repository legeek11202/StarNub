...
public class SN_Configuration {
	...
	{
    	SN_MessageFormater.msgPrint("Checking for StarNub Directories...", 0);
    	SN_Directories_Files.snDirCheck();
    	SN_MessageFormater.msgPrint("Directory check complete.", 0);
    	
    	SN_MessageFormater.msgPrint("Checking for StarNub Configuration...", 0);
    	if (SN_Directories_Files.snConfigCheck())
    	{
    		SN_MessageFormater.msgPrint("Validating the StarNub Configuration...", 0);
    		// TODO Config Validation Call
    		// TODO Config Load Call
    	}
    	else 
    	{
    		SN_MessageFormater.msgPrint("Creating StarNub Configuration...", 0);
