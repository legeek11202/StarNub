...
public class ServerPacketProcessor implements Runnable {

    public static ArrayBlockingQueue<Packet> ServerPacketQue = new ArrayBlockingQueue<Packet>(5000);
    ...
    public void run() {
        while (true) {
            ...
            if (ServerPacketQue.remainingCapacity() <= 4975) {
                //DEBUG
                System.out.println("Server Packet Que: " + ServerPacketQue.remainingCapacity());
            }
            try {
